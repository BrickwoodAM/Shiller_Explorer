...
Downloads Robert Shiller's ie_data.xls from shillerdata.com and regenerates
the three JSON data files used by the explorer (index.html fetches these at
page load, so committing updated JSONs is all that's needed).
